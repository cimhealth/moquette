...
//        m_processor.processPubComp(m_channel,pubCompMessage1);
    ...
    public void testSubscribe() {
        ...
        msg.addSubscription(new SubscribeMessage.Couple(QOSType.MOST_ONE.byteValue(), FAKE_TOPIC));
        m_sessionStore.createNewSession(FAKE_CLIENT_ID, false);
    ...
    public void testSubscribedToNotAuthorizedTopic() {
        ...
        assertTrue(subAckMsg.types().contains(QOSType.FAILURE));
    }
    ...
    public void testSubscribeWithBadFormattedTopic() {
        SubscribeMessage msg = new SubscribeMessage();
        msg.addSubscription(new SubscribeMessage.Couple(QOSType.MOST_ONE.byteValue(), BAD_FORMATTED_TOPIC));
        m_sessionStore.createNewSession(FAKE_CLIENT_ID, false);
        assertEquals(0, subscriptions.size());
    ...
    public void testForwardPublishWithCorrectQos() {
        ...
        ProtocolProcessor processor = new ProtocolProcessor() {
            @Override
            protected void directSend(ClientSession session, String topic, QOSType qos, ByteBuffer message,
